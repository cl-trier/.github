...
We're happy to receive input from staff and students alike.  
If you'd like to suggest improvements, fix errors, or add new resources, feel free to fork a repository and open a pull request — or contact the department via [Mattermost](https://mattermost.gitlab.rlp.net/cldh-trier/channels/town-square) or [mail](itcldh@uni-trier.de).
